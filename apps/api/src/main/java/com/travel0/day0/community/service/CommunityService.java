// CommunityService.java - 중복된 getGroups 메서드 제거
...
public class CommunityService {
    ...
    public List<CommunityGroupResponse> getGroups(String countryCode, Long universityId) {
        ...
        try {
            // 임시로 빈 리스트 반환 (Repository 메서드가 없을 경우)
            return List.of(
                CommunityGroupResponse.builder()
                    .groupKey("US_ALL")
                    .groupName("미국 전체")
                    .countryCode("US")
                    .countryName("미국")
...
//    }
    ...
    private PostResponse convertToPostResponse(CommunityPost post, Long currentUserId) {
        ...
        return PostResponse.builder()
                ...
                .hasAdoptedReply(false) // 임시
                .adoptedReplyId(null) // 임시
