          ...
          <div className={styles.pageContent}>
            ...
            <div className={editStyles.container}>
              <div className={editStyles.header}>
                <button
                  className={`${editStyles.privacyButton} ${
                    isPrivate ? editStyles.private : editStyles.public
                  }`}
                ...
                {Object.keys(groupedItems).length === 0 ? (
                  ...
                  Object.entries(groupedItems).map(
                    ([category, categoryItems]) => (
                      <div
                        key={category}
                        className={editStyles.categorySection}
                      >
                        <div className={editStyles.categoryHeader}>
                          <div className={editStyles.categoryCell}>
                            <span className={editStyles.categoryLabel}>
                              {category}
                            </span>
                          </div>
                        </div>
                          ...
                          <div key={item.uciId} className={editStyles.itemRow}>
                            <div className={editStyles.nameCell}>
                              <input
                                ...
                                value={item.title}
                                onChange={(e) =>
                                  updateItemName(item.uciId, e.target.value)
                                }
